...
当前内置版本号：`20260919-V4`（见 `version.go`）。
...
例如当前版本 `20260919-V4` 会对应 Release 标签 `v20260919-V4`。同一版本后续普通提交不会重复创建 Release；需要重新发布同一版本时，可在 Actions 页面手动执行 `Run workflow` 并填写对应的 `release_tag`。
